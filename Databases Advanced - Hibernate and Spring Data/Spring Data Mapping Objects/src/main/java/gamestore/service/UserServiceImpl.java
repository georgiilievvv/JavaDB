...
public class UserServiceImpl implements UserService {
    ...
    public String registerUser(UserRegisterDto userRegisterDto) {
        ...
        if (!userRegisterDto.getPassword().equals(userRegisterDto.getConfirmPassword())) {
            ...
            sb.append("+------------------------------------------------------------+")
                    ...
                    .append("Cannot register user because of the following validation errors")
                    .append(System.lineSeparator())
                    .append("+------------------------------------------------------------+")
                    .append(System.lineSeparator());
    ...
    public String loginUser(UserLoginDto userLoginDto) {
        ...
        if (violations.size() > 0) {
            sb.append("+------------------------------------------------------------+")
                    .append(System.lineSeparator())
                    .append("Cannot login user because of the following validation errors")
                    .append(System.lineSeparator())
                    .append("+------------------------------------------------------------+")
                    .append(System.lineSeparator());
    ...
    @Override
    public String OwnedGames(String loggedInUserEmail) {

        User entity = this
                .userRepository
                .findByEmail(loggedInUserEmail)
                .orElse(null);
        OwnedGamesDto dto = modelMapper.map(entity, OwnedGamesDto.class);

        if (dto.getGames().size() == 0){
            return entity.getFullName() + " has no games.";
        }
