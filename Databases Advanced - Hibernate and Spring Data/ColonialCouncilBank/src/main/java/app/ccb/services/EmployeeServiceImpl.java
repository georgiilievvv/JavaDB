...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    private final static String EMPLOYEES_JSON_FILE_PATH = "C:\\Users\\joroi\\Desktop\\ZIPS\\ColonialCouncilBank\\src\\main\\resources\\files\\json\\employees.json";
    ...
    public String exportTopEmployees() {
        ...
        for (Employee employee : employees) {
            result.append("Full Name: ").append(employee.getFirstName() + " " + employee.getLastName())
                    .append(System.lineSeparator())
                    .append("Salary: ").append(employee.getSalary())
                    .append(System.lineSeparator())
                    .append("Started On: ").append(employee.getStartedOn())
                    .append(System.lineSeparator())
                    .append("Clients: ").append(System.lineSeparator());
            for (Client client : employee.getClients()) {
                result.append("   ").append(client.getFullName())
                        .append(System.lineSeparator());
            }
